...
const savingsManagerAddress = "0x9781C4E9B9cc6Ac18405891DF20Ad3566FB6B301"
  ...
  .setAction(async (_, { ethers }) => {
    ...
    const lastInterestCollectionBN = await savingsManager.lastCollection(mUSDAddress)
    const lastInterestCollectionDate = new Date(lastInterestCollectionBN.toNumber() * 1000)
    console.log(`Last interest collection ${lastInterestCollectionBN}, ${lastInterestCollectionDate}`)
  })
